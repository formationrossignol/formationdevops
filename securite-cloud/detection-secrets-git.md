...
# TP : Détection de secrets dans un dépôt Git
...
| Compétence | Niveau |
|---|---|
| Comprendre le risque des secrets dans le code | Débutant |
| Identifier des secrets dans un dépôt Git | Intermédiaire |
| Utiliser Gitleaks | Intermédiaire |
| Utiliser TruffleHog | Intermédiaire |
| Différencier fichier courant et historique Git | Intermédiaire |
| Nettoyer un secret d'un dépôt local | Intermédiaire |
| Mettre en place un contrôle avant commit | Intermédiaire |
