      ...
      sidebar: [
        { label: 'Introduction', slug: '' },
        {
          ...
          items: [
            ...
            { label: 'TP 14 : Terragrunt avec Terraform/OpenTofu', slug: 'terraform/tp14-terragrunt' },
            { label: 'TP 15 : Kind (Kubernetes in Docker)', slug: 'terraform/tp15-kind' },
            { label: 'TP 16 : Provider Kubernetes de Terraform', slug: 'terraform/tp16-provider-kubernetes' },
            { label: 'TP 17 : Utilisation générique de Helm', slug: 'terraform/tp17-helm-generique' },
            { label: 'TP 18 : Utilisation de Helm', slug: 'terraform/tp18-helm' },
            { label: 'TP 19 : Provider Helm de Terraform', slug: 'terraform/tp19-provider-helm' },
            { label: 'TP 20 : LocalStack', slug: 'terraform/tp20-localstack' },
            { label: 'TP 21 : Intégration de HashiCorp Vault', slug: 'terraform/tp21-vault' },
          ],
        },
      ],
      lastUpdated: true,
