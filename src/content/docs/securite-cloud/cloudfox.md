...
| Compétence |
|---|
| Installer et utiliser CloudFox |
| Comprendre une cartographie AWS |
| Identifier les identités IAM |
| Lire les permissions IAM attribuées |
| Comprendre les relations de confiance IAM |
| Identifier des permissions sensibles |
| Lire les fichiers de sortie d'un outil d'audit |
| Nettoyer les ressources IAM temporaires |
