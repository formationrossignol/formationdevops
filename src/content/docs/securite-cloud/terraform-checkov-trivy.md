...
| Comprendre la différence entre syntaxe valide et configuration sécurisée |
| Identifier des mauvaises configurations IaC |
| Utiliser Checkov |
| Utiliser Trivy pour l'analyse IaC |
| Corriger une configuration Terraform |
| Réduire une politique IAM trop large |
