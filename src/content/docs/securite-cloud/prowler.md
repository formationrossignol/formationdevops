...
| Compétence |
|---|
| Lancer un inventaire sécurité AWS |
| Comprendre les constats Prowler |
| Identifier les risques IAM prioritaires |
| Lire un rapport JSON, CSV ou HTML |
| Filtrer des résultats de sécurité |
| Prioriser les constats |
| Appliquer une remédiation IAM simple |
| Comparer deux analyses de sécurité |
