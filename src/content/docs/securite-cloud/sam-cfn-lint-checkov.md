...
|---|
| Lire un modèle SAM |
| Déployer une fonction Lambda simple |
| Comprendre les rôles IAM Lambda |
| Analyser un modèle CloudFormation avec cfn-lint |
| Analyser un modèle SAM avec Checkov |
| Corriger des permissions IAM trop larges |
| Lire les journaux CloudWatch Logs d'une Lambda |
