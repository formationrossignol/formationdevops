...
| Compétence |
|---|
| Lire une configuration Terraform |
| Générer un plan Terraform |
| Comprendre une estimation de coût cloud |
| Utiliser Infracost |
| Identifier les ressources coûteuses |
| Comparer deux variantes d'infrastructure |
| Proposer des optimisations FinOps |
